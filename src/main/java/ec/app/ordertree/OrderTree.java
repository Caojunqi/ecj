...
public class OrderTree extends GPProblem implements SimpleProblemForm {
    ...
    public void setup(final EvolutionState state,
        ...
        if (fitnessContributionType < CONTRIBUTION_UNIT || fitnessContributionType > CONTRIBUTION_EXPONENTIAL)
    ...
    double fitnessContribution(double value, EvolutionState state) {
        switch (fitnessContributionType) {
            case CONTRIBUTION_UNIT:
                return 1.0;
            case CONTRIBUTION_VALUE:
                return value;
            case CONTRIBUTION_SQUARE:
                return value * value;
            case CONTRIBUTION_EXPONENTIAL:
