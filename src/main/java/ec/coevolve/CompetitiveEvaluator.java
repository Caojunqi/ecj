 ...
 * his method over <b>K-Random-Opponents-One-Way</b> is a reduced number of competitions (when I competes
 * gainst J, both I's and J's fitnesses are updated, while in the previous method only one of the individuals
 * as its fitness updated).
 * or details, see "A Comparison of Two Competitive Fitness Functions" by Liviu Panait and
 * ean Luke in the Proceedings of GECCO 2002.
 * /dl>
 * <p>
 * p><b>Parameters</b><br>
 * <table>
